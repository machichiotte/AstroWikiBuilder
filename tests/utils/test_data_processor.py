...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertIsNotNone(self.processor.repository)
    ...
    def test_add_exoplanets_from_source(self):
        ...
        self.mock_repository.add_exoplanets.assert_called_once_with(sample_exoplanets, "test_source")
    ...
    def test_get_statistics(self):
        ...
        self.mock_repository.get_all_exoplanets.assert_called_once()
        self.mock_stat_service.generate_statistics.assert_called_once_with(mock_exoplanets)
    ...
    def test_get_and_separate_wikipedia_articles_by_status(self):
        ...
        mock_all_articles_info = {
            "PlanetA": {
                "enwiki": WikiArticleInfo(query_name="PlanetA", article_exists=True, title="PlanetA_title", url="http://en.wikipedia.org/wiki/PlanetA_title", is_redirect=False, redirect_target=None)
            }
        }
        ...
        self.mock_repository.get_all_exoplanets.return_value = mock_exoplanets
        self.mock_wiki_service.get_all_articles_info_for_exoplanets.return_value = mock_all_articles_info
        self.mock_wiki_service.separate_articles_by_status.return_value = mock_separated_articles
        
        existing, missing = self.processor.get_and_separate_wikipedia_articles_by_status()
        
        self.mock_repository.get_all_exoplanets.assert_called_once()
        self.mock_wiki_service.get_all_articles_info_for_exoplanets.assert_called_once_with(mock_exoplanets)
        self.mock_wiki_service.separate_articles_by_status.assert_called_once_with(mock_all_articles_info)
    ...
    def test_export_exoplanet_data_csv(self):
        ...
        self.mock_repository.get_all_exoplanets.assert_called_once()
        self.mock_export_service.export_exoplanets_to_csv.assert_called_once_with('file.csv', mock_exoplanets)
    ...
    def test_export_exoplanet_data_json(self):
        ...
        self.mock_repository.get_all_exoplanets.assert_called_once()
        self.mock_export_service.export_exoplanets_to_json.assert_called_once_with('file.json', mock_exoplanets)
    ...
    def test_export_wikipedia_links_data(self):
        ...
        mock_repo_exoplanets = [Exoplanet(name="PlanetA", host_star=MagicMock())] # Added host_star as it's in headers
        self.mock_repository.get_all_exoplanets.return_value = mock_repo_exoplanets
        
        mock_wiki_article_info = WikiArticleInfo(query_name="PlanetA", article_exists=True, title="PlanetA_title", url="url", is_redirect=False, redirect_target=None)
        ...
        self.mock_wiki_service.format_wiki_links_data_for_export.return_value = mock_formatted_list
        
        self.processor.export_wikipedia_links_data("base_file", mock_wiki_data_map, "existing")
        
        self.mock_repository.get_all_exoplanets.assert_called_once() # Called by export_wikipedia_links_data
        self.mock_wiki_service.format_wiki_links_data_for_export.assert_called_once_with(mock_repo_exoplanets, mock_wiki_data_map)
        
        self.mock_export_service.export_generic_list_of_dicts_to_csv.assert_called_once()
        args_csv, kwargs_csv = self.mock_export_service.export_generic_list_of_dicts_to_csv.call_args
        ...
        args_json, _ = self.mock_export_service.export_generic_list_of_dicts_to_json.call_args
    ...
    def test_export_wikipedia_links_data_no_formatted_list(self):
        ...
        self.processor.export_wikipedia_links_data("base", mock_wiki_data_map, "existing")
