"""
Tests unitaires pour ExoplanetComparisonUtils.
...
class TestExoplanetComparisonUtils:
    """Tests pour ExoplanetComparisonUtils."""

    @pytest.fixture
    def comparison_utils(self):
        """Fixture pour créer un ExoplanetComparisonUtils."""
        return ExoplanetComparisonUtils()
    ...
    def test_describe_radius_no_radius(self, comparison_utils, create_exoplanet):
        """Test avec aucun rayon."""
        exo = create_exoplanet()
        result = comparison_utils.describe_radius_vs_known_planets(exo)
        assert result == ""

    def test_describe_radius_similar_to_jupiter(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_radius_larger_than_jupiter(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_radius_similar_to_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_radius_larger_than_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_radius_smaller_than_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_mass_no_mass(self, comparison_utils, create_exoplanet):
        """Test avec aucune masse."""
        exo = create_exoplanet()
        result = comparison_utils.describe_mass_vs_known_planets(exo)
        assert result == ""

    def test_describe_mass_similar_to_jupiter(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_mass_larger_than_jupiter(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_mass_similar_to_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_mass_larger_than_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_mass_smaller_than_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_no_sma(self, comparison_utils, create_exoplanet):
        """Test avec aucun demi-grand axe."""
        exo = create_exoplanet()
        result = comparison_utils.describe_orbit_vs_solar_system(exo)
        assert result == ""

    def test_describe_orbit_closer_than_mercury(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_mercury(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_between_mercury_and_venus(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_venus(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_earth(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_mars(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_asteroid_belt(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_jupiter(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_saturn(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_uranus(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_similar_to_neptune(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_farther_than_neptune(self, comparison_utils, create_exoplanet):
    ...
    def test_describe_orbit_with_float_sma(self, comparison_utils, create_exoplanet):
