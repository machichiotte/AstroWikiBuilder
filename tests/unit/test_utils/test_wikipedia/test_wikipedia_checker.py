...
class TestWikipediaChecker:
    ...
    def test_fetch_raw_article_query_from_mediawiki_success(self, mock_get, checker):
        ...
        mock_response.json.return_value = {
            "query": {
                "pages": {
                    "123": {"title": "Test Article", "fullurl": "https://fr.wikipedia.org/wiki/Test_Article"}
                }
            }
        }
    ...
    def test_build_title_normalization_and_redirect_maps_no_data(self, checker):
        ...
        normalized, redirect, resolved = checker.build_title_normalization_and_redirect_maps(data, titles)
    ...
    def test_build_title_normalization_and_redirect_maps_with_normalization(self, checker):
        ...
        data = {
            "normalized": [{"from": "article 1", "to": "Article 1"}]
        }
        titles = ["article 1"]
    ...
    def test_resolve_article_existence_missing_page(self, checker):
        ...
        results = {"Missing Article": WikiArticleInfo(exists=False, title="Missing Article", queried_title="Missing Article")}
        resolved_map = {"Missing Article": "Missing Article"}
        
        checker.resolve_article_existence_from_pages(
            data, resolved_map, {}, {}, results, None
        )
    ...
    def test_resolve_article_existence_existing_page(self, checker):
        ...
        results = {"Existing Article": WikiArticleInfo(exists=False, title="Existing Article", queried_title="Existing Article")}
    ...
    def test_resolve_article_existence_with_redirect(self, checker):
        ...
        results = {"Source Article": WikiArticleInfo(exists=False, title="Source Article", queried_title="Source Article")}
    ...
    def test_resolve_article_existence_with_host_star_match(self, checker):
        ...
        results = {"Kepler-22 b": WikiArticleInfo(exists=False, title="Kepler-22 b", queried_title="Kepler-22 b")}
