...
if __name__ == "__main__":
    ...
    sirius_data = {
        ...
        "temperature": DataPoint(
            value=9940, unit="K"
        ),  # Surface temperature of component A
    ...
    proxima_data = {
        ...
        "designations": DataPoint(
            "V645 Cen, Alpha Centauri C, GCTP 3309.02, HIP 70890"
        ),  # String to be split by Star class
    }
    proxima_star = Star(
        **proxima_data
    )  # __post_init__ in Star should handle splitting designations
