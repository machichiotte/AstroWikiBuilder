...
class WikipediaStarGenerator:
    ...
    def __init__(self):
        ...
        # self.reference_manager = ReferenceManager() # If needed later
...
if __name__ == '__main__':
    ...
    article_content = star_article_generator.generate_article_content(sirius_star_object)
    ...
    article_content_proxima = star_article_generator.generate_article_content(proxima_star_object)
