# src/generators/star_article_generator.py
import locale
import re
...
class ArticleStarGenerator(BaseWikipediaArticleGenerator):
    """
    ...
    def compose_article_content(
        ...
        parts.append(self.infobox_generator.build_infobox(star))
    ...
    def build_palettes_section(self, object: Star) -> Optional[str]:
        ...
        gender = CONSTELLATION_GENDER_FR.get(constellation)
