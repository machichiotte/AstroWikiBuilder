...
class StarInfoboxGenerator:
    ...
    def generate_star_infobox(self, star: Star) -> str:
        ...
        infobox += f" | carte UAI = {self.constellation_utils.get_constellation_name(star.right_ascension.value, star.declination.value)}\n"
        ...
        infobox += f" | constellation = {self.constellation_utils.get_constellation_UAI(star.right_ascension.value, star.declination.value)}\n"
